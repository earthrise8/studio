...
const prompt = ai.definePrompt({
  ...
  prompt: `You are a recipe extraction expert. Given a URL, extract the recipe details, including name, ingredients, instructions, prep time, cook time, total time, and a short description.
